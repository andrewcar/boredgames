...
class PlayView: UIView {
    ...
    private func activateLogoPortraitConstraints() {
        ...
        logoPortraitConstraints = [
            logoImageView.topAnchor.constraint(equalTo: topAnchor, constant: Frame.Logo.upperPadding),
            logoImageView.centerXAnchor.constraint(equalTo: centerXAnchor),
            logoImageView.widthAnchor.constraint(equalToConstant: Frame.Logo.size.width),
            logoImageView.heightAnchor.constraint(equalToConstant: Frame.Logo.size.height)
        ]
    ...
    private func activateNotInWordListPortraitConstraints() {
        ...
        notInWordListPortraitConstraints = [
            notInWordListView.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: 0),
    ...
    private func activateGridViewPortraitConstraints() {
        ...
        gridViewPortraitConstraints = [
            gridView.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: Frame.Grid.upperPadding),
    ...
    private func activateStatsViewPortraitConstraints() {
        ...
        statsViewPortraitConstraints = [
            statsView.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: Frame.Grid.upperPadding),
    ...
    private func activateStatsViewLandscapeConstraints() {
        ...
        statsViewLandscapeConstraints = [
            statsView.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: Frame.padding),
